...
`pkgwhy` is a pre-alpha project. The current local candidate is `0.4.0a0`. It is not a production security scanner and should not be treated as a definitive malware detector.
